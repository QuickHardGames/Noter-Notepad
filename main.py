...
class Noter:
    ...
    def __init__(self,**kwargs):
        ...
        # Set icon
        try:
                self.__root.wm_iconbitmap("Noter.ico")
        except:
                pass
        ...
        # Set the window text
        self.__root.title("Untitled - Noter")
        ...
        # To create a feature of description of the Noter
        self.__thisHelpMenu.add_command(label="About Noter",
    ...
    def __showAbout(self):
        showinfo("Noter","This is a Application By QuickHardGames. Check Here - http://quickhardgames.net")
    ...
    def __openFile(self):
        ...
        if self.__file == "":
            ...
            self.__root.title(os.path.basename(self.__file) + " - Noter")
...
# Run main application
Noter = Noter(width=600,height=400)
Noter.run()